...
const HeroSection = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="min-h-screen pt-28 pb-20 px-6 flex flex-col justify-center"
      id="hero"
    >
      <div className="max-w-7xl mx-auto w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="lg:w-1/2 space-y-6">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight hero-title">
              The Art of <span className="text-primary font-calligraphy">Beautiful</span> Writing
            </h1>
            
            <p className="text-lg text-muted-foreground max-w-lg hero-subtitle">
          ...
          <div className="lg:w-1/2" ref={gridRef}>
              ...
              {Array.from({ length: 9 }).map((_, index) => (
                ...
                >
                  <div className="grid-content">
                    <span className="text-white font-calligraphy text-3xl font-medium">
