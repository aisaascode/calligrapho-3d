...
const WorksSection = () => {
  ...
  useEffect(() => {
    ...
    // Gallery animations - using staggered reveal
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-16 md:py-24 px-4 md:px-6 bg-secondary/30 background-gradient parallax-section"
      id="works"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <span className="px-3 py-1 text-sm rounded-full border border-primary/30 bg-primary/5 text-primary works-tag inline-block">
            Recent Works
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mt-6 works-title stagger-text">
        ...
        <div ref={galleryRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 stagger-container">
          {works.map((work) => (
            <div key={work.id} className="gallery-item stagger-item group overflow-hidden rounded-2xl relative fade-in-scale cursor-pointer">
              ...
              <div className="overlay-content absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4 md:p-6">
